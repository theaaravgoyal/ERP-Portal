  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Track personnel logs, manage check-ins/outs, and generate reports."
      >
        <Button 
          variant="secondary" 
      ...
      <Card className="text-center max-w-2xl mx-auto relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-48 bg-blue-500/5 blur-[60px] pointer-events-none rounded-full"></div>
        
        <div className="w-16 h-16 bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-blue-500/5 mb-6">
        ...
        <div className="space-y-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-800 tracking-tight">Personnel Access Panel</h2>
        ...
        <div className="border-t border-rose-100 pt-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-left">
            <div className="p-4 bg-[#fdf8f8] border border-rose-100 rounded-xl">
              ...
              <code className="text-[11px] text-brand-red">/attendance</code>
            </div>
            <div className="p-4 bg-[#fdf8f8] border border-rose-100 rounded-xl">
              <span className="text-[10px] text-slate-500 font-bold uppercase block mb-1">Subfolder</span>
              <span className="text-xs font-semibold text-emerald-600">Modules/Attendance/</span>
            </div>
