    ...
    <div className="space-y-6">
      ...
      <Card className="text-center max-w-2xl mx-auto relative overflow-hidden">
        ...
        <div className="space-y-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-white tracking-tight">Financial Operations Panel</h2>
        ...
        <div className="border-t border-slate-800/60 pt-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-left">
            ...
            <div className="p-4 bg-slate-950/40 border border-slate-800/40 rounded-xl">
              ...
              <span className="text-xs font-semibold text-emerald-400">Modules/FeesManagement/</span>
            </div>
